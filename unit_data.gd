...
var unit_templates = {
	...
	"healer": {
		...
		"regen_amount": 5,
		"regen_turns": 4,
		"heal_stamina_cost": 20,
		"regen_stamina_cost": 20,
	...
	"archer": {
		...
		"hp": 20,
		"attack": 8,
		"attack_stamina_cost": 80,
		"counter_stamina_cost": 999,
		"counter_damage_multiplier": 0.0,
		"stamina_per_damage": 10,
		"heal_amount": 0,
		"regen_amount": 0,
		"regen_turns": 0,
		"heal_stamina_cost": 0,
...
func create_unit(
	...
	var unit = {
		...
		"stamina_per_damage": template["stamina_per_damage"],
